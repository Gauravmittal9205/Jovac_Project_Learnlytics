...
function MyInstructorsPage() {
  ...
  const [instructors, setInstructors] = useState([
    {
      ...
      specialties: ['Algorithms', 'Software Design', 'Machine Learning'],
      bio: 'Dr. Johnson is a renowned expert in computer science with over 15 years of teaching experience. She specializes in algorithms and software engineering.',
      avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=150&h=150&fit=crop&crop=face',
      isAvailable: true,
      responseTime: '2-4 hours',
      communicationStyle: 'Professional and approachable',
      teachingMethod: 'Interactive lectures with hands-on projects',
      lastInteraction: '2 days ago',
      upcomingOfficeHours: 'Today, 2:00 PM',
      totalStudents: 45,
      averageGrade: 'B+',
      studentFeedback: [
    ...
    },
    {
      ...
      specialties: ['Linear Algebra', 'Differential Equations', 'Statistics'],
      bio: 'Prof. Chen brings a passion for mathematics and a clear teaching style that helps students understand complex concepts.',
      avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face',
      isAvailable: true,
      responseTime: '1-2 hours',
      communicationStyle: 'Clear and methodical',
      teachingMethod: 'Step-by-step problem solving',
      lastInteraction: '1 week ago',
      upcomingOfficeHours: 'Tomorrow, 1:00 PM',
      totalStudents: 38,
      averageGrade: 'A-',
      studentFeedback: [
        'Makes difficult concepts easy to understand',
        'Very patient with questions',
        'Great at explaining step-by-step'
      ]
    },
    {
      id: 3,
      ...
      office: 'IT Building, Room 150',
      officeHours: 'Mon, Wed 10:00-12:00 PM',
      courses: ['Database Systems', 'Data Management'],
      rating: 4.9,
      totalRatings: 95,
      experience: '8 years',
      education: 'PhD in Information Systems, Berkeley',
      specialties: ['Database Design', 'SQL', 'Data Analytics'],
      bio: 'Dr. Rodriguez is an expert in database systems with a focus on practical applications and real-world projects.',
      ...
      upcomingOfficeHours: 'Next Monday, 10:00 AM',
      totalStudents: 42,
      averageGrade: 'A',
      studentFeedback: [
        'Amazing teacher, very engaging',
        'Projects are challenging but rewarding',
        'Always willing to help outside office hours'
      ]
    }
  ]);
  ...
  const filteredInstructors = instructors.filter(instructor => {
    ...
    const matchesFilter = filterBy === 'all' || 
                         (filterBy === 'available' && instructor.isAvailable) ||
                         (filterBy === 'high-rated' && instructor.rating >= 4.7) ||
                         (filterBy === 'recent' && instructor.lastInteraction.includes('day'));
  ...
  const handleScheduleMeeting = (instructor) => {
    setSelectedInstructor(instructor);
    setScheduleData({ date: '', time: '', purpose: '' });
    setShowScheduleModal(true);
  };

  const handleRateInstructor = (instructor) => {
    setSelectedInstructor(instructor);
  ...
  const handleSendMessageSubmit = () => {
    if (messageData.subject && messageData.message) {
      ...
      console.log(`Message sent to ${selectedInstructor.name}: ${messageData.subject}`);
  ...
  const handleScheduleSubmit = () => {
    if (scheduleData.date && scheduleData.time && scheduleData.purpose) {
      ...
      console.log(`Meeting scheduled with ${selectedInstructor.name} on ${scheduleData.date} at ${scheduleData.time}`);
  ...
  const handleRateSubmit = () => {
    if (ratingData.rating >= 1 && ratingData.rating <= 5) {
      ...
      console.log(`Rated ${selectedInstructor.name} with ${ratingData.rating} stars`);
  ...
  const handleAddInstructor = () => {
    // For now, add a sample instructor
    const newInstructor = {
      id: instructors.length + 1,
      name: 'New Instructor',
      title: 'Professor',
      department: 'General',
      email: 'new.instructor@university.edu',
      ...
      education: 'TBD',
      specialties: ['TBD'],
      bio: 'New instructor - information pending',
      avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face',
      isAvailable: false,
      responseTime: 'TBD',
    ...
    console.log(`Instructor ${newInstructor.name} added successfully!`);
  };
          ...
          <div className="dashboard-section">
            <div className="instructors-header">
              <div className="header-content">
                ...
                <p>Connect with your instructors and manage your academic relationships</p>
              </div>
            ...
            <div className="search-filters">
              <div className="search-bar">
                ...
                <input
                  type="text"
                  placeholder="Search instructors, departments, or courses..."
                  value={searchTerm}
          ...
          <div className="dashboard-section">
            <div className="instructors-grid">
              {sortedInstructors.map(instructor => (
                <div key={instructor.id} className="instructor-card" onClick={() => handleInstructorClick(instructor)}>
                  <div className="instructor-header">
                    <div className="instructor-avatar">
                      <img src={instructor.avatar} alt={instructor.name} />
                      <div className={`availability-indicator ${instructor.isAvailable ? 'online' : 'offline'}`}></div>
                    </div>
                    ...
                    <div className="instructor-rating">
                      <div className="rating-stars">
                        {[...Array(5)].map((_, i) => (
                          <svg
                            ...
                            height="16"
                            viewBox="0 0 24 24"
                            fill={i < Math.floor(instructor.rating) ? "#fbbf24" : "#e5e7eb"}
                      ...
                      <span className="rating-count">({instructor.totalRatings})</span>
                    </div>
                  </div>
                  ...
                  <div className="instructor-stats">
                    ...
                    <div className="stat">
                      ...
                      <span className="stat-value">{instructor.averageGrade}</span>
                    </div>
                  </div>
                  ...
                  <div className="instructor-actions">
                    ...
                    <button 
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handleScheduleMeeting(instructor);
                      }}
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button 
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handleRateInstructor(instructor);
                      }}
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="dashboard-layout">
      ...
      <div className={`dashboard-main ${sidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
        ...
        <div className="dashboard-container">
          ...
          {/* Message Modal */}
          {showMessageModal && selectedInstructor && (
            <div className="modal-overlay" onClick={() => setShowMessageModal(false)}>
              <div className="action-modal" onClick={(e) => e.stopPropagation()}>
                <div className="modal-header">
                  <div className="modal-title-section">
                    <h2>Send Message</h2>
                    <p>Send a message to {selectedInstructor.name}</p>
                  </div>
                ...
                <div className="modal-content">
                  ...
                  <div className="instructor-info-card">
                    ...
                    <div className="instructor-details-small">
                      <h4>{selectedInstructor.name}</h4>
                      <p>{selectedInstructor.title}</p>
                      <p className="email">{selectedInstructor.email}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="modal-footer">
                  ...
                  <button className="btn primary" onClick={handleSendMessageSubmit}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="action-modal" onClick={(e) => e.stopPropagation()}>
                <div className="modal-header">
                  <div className="modal-title-section">
                    ...
                    <p>Schedule a meeting with {selectedInstructor.name}</p>
                  </div>
                ...
                <div className="modal-content">
                  ...
                  <div className="form-group">
                    <label htmlFor="schedule-purpose">Purpose of Meeting</label>
                    <select
                      id="schedule-purpose"
                  ...
                  <div className="instructor-info-card">
                    ...
                    <div className="instructor-details-small">
                      <h4>{selectedInstructor.name}</h4>
                      <p>{selectedInstructor.title}</p>
                      <p className="office-hours">Office Hours: {selectedInstructor.officeHours}</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="action-modal" onClick={(e) => e.stopPropagation()}>
                <div className="modal-header">
                  <div className="modal-title-section">
                    ...
                    <p>Rate your experience with {selectedInstructor.name}</p>
                  </div>
                  ...
                  <div className="instructor-info-card">
                    ...
                    <div className="instructor-details-small">
                      ...
                      <div className="current-rating">
                        ...
                        <div className="rating-stars-small">
                          {[...Array(5)].map((_, i) => (
                            <svg
                              ...
                              height="16"
                              viewBox="0 0 24 24"
                              fill={i < Math.floor(selectedInstructor.rating) ? "#fbbf24" : "#e5e7eb"}
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        ...
                        <span>({selectedInstructor.totalRatings} reviews)</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="modal-footer">
                  ...
                  <button className="btn primary" onClick={handleRateSubmit}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    Submit Rating
